...
using Microsoft.AspNet.OData.Authorization.Tests.Models;
...
namespace Microsoft.AspNet.OData.Test.Authorization
{
    public class ODataAuthorizationTest
    {
        ...
        [InlineData("GET", "Products/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "Product.Read", "GET SpecialProducts")]
        [InlineData("GET", "Products/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/$count", "Product.Read", "GET SpecialProducts")]
        // POST /entityset
        [InlineData("POST", "Products", "Product.Insert", "POST Products")]
        [InlineData("POST", "Products/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "Product.Insert", "POST SpecialProduct")]
        // GET /entityset/key
        [InlineData("GET", "Products(10)", "Product.ReadByKey", "GET Products(10)")]
        [InlineData("GET", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "Product.ReadByKey", "GET SpecialProduct(10)")]
        // DELETE /entityset/key
        [InlineData("DELETE", "Products(10)", "Product.Delete", "DELETE Products(10)")]
        [InlineData("DELETE", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "Product.Delete", "DELETE SpecialProduct(10)")]
        // PUT /entityset/key
        [InlineData("PUT", "Products(10)", "Product.Update", "PUT Products(10)")]
        [InlineData("PUT", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "Product.Update", "PUT SpecialProduct(10)")]
        // PATCH /entityset/key
        [InlineData("PATCH", "Products(10)", "Product.Update", "PATCH Products(10)")]
        [InlineData("PATCH", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "Product.Update", "PATCH SpecialProduct(10)")]
        [InlineData("MERGE", "Products(10)", "Product.Update", "PATCH Products(10)")]
        [InlineData("MERGE", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "Product.Update", "PATCH SpecialProduct(10)")]
        // /singleton and /singleton/cast
        [InlineData("GET", "MyProduct", "MyProduct.Read", "GET MyProduct")]
        [InlineData("GET", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "MyProduct.Read", "GET MySpecialProduct")]
        [InlineData("PUT", "MyProduct", "MyProduct.Update", "PUT MyProduct")]
        [InlineData("PUT", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "MyProduct.Update", "PUT MySpecialProduct")]
        [InlineData("PATCH", "MyProduct", "MyProduct.Update", "PATCH MyProduct")]
        [InlineData("PATCH", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "MyProduct.Update", "PATCH MySpecialProduct")]
        [InlineData("MERGE", "MyProduct", "MyProduct.Update", "PATCH MyProduct")]
        [InlineData("MERGE", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct", "MyProduct.Update", "PATCH MySpecialProduct")]
        // bound functions
        ...
        [InlineData("GET", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/FunctionBoundToProduct", "Product.Function", "FunctionBoundToProduct(10)")]
        // entityset functions
        [InlineData("GET", "Products/TopProductOfAll", "Product.Top", "TopProductOfAll()")]
        [InlineData("GET", "Products/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/TopProductOfAll", "Product.Top", "TopProductOfAll()")]
        // singleton functions
        [InlineData("GET", "MyProduct/FunctionBoundToProduct", "Product.Function", "FunctionBoundToProduct()")]
        [InlineData("GET", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/FunctionBoundToProduct", "Product.Function", "FunctionBoundToProduct()")]
        // entity actions
        ...
        [InlineData("POST", "RoutingCustomers(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.VIP/GetSalesPerson", "Customer.GetSalesPerson", "GetSalesPersonOnVIP(10)")]
        // entityset actions
        [InlineData("POST", "RoutingCustomers/GetProducts", "Customer.GetProducts", "GetProducts()")]
        [InlineData("POST", "RoutingCustomers/Microsoft.AspNet.OData.Authorization.Tests.Models.VIP/GetSalesPeople", "Customer.GetSalesPeople", "GetSalesPeopleOnVIP()")]
        // singleton actions
        [InlineData("POST", "VipCustomer/Microsoft.AspNet.OData.Authorization.Tests.Models.VIP/GetSalesPerson", "Customer.GetSalesPerson", "GetSalesPerson()")]
        ...
        [InlineData("GET", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name", "Product.ReadByKey", "GetProductName(10)")]
        [InlineData("GET", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name/$value", "Product.ReadByKey", "GetProductName(10)")]
        [InlineData("GET", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Tags/$count", "Product.ReadByKey", "GetProductTags(10)")]
        [InlineData("DELETE", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name", "Product.Update", "DeleteProductName(10)")]
        [InlineData("PATCH", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name", "Product.Update", "PatchProductName(10)")]
        [InlineData("PUT", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name", "Product.Update", "PutProductName(10)")]
        [InlineData("POST", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Tags", "Product.Update", "PostProductTags(10)")]
        // singleton/property
        ...
        [InlineData("GET", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name", "MyProduct.Read", "GetMyProductName")]
        [InlineData("GET", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name/$value", "MyProduct.Read", "GetMyProductName")]
        [InlineData("GET", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Tags/$count", "MyProduct.Read", "GetMyProductTags")]
        [InlineData("DELETE", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name", "MyProduct.Update", "DeleteMyProductName")]
        [InlineData("PATCH", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name", "MyProduct.Update", "PatchMyProductName")]
        [InlineData("PUT", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Name", "MyProduct.Update", "PutMyProductName")]
        [InlineData("POST", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/Tags", "MyProduct.Update", "PostMyProductTags")]
        // dynamic properties
        ...
        [InlineData("POST", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/RoutingCustomers", "Customer.Insert", "PostMyProductCustomer")]
        // $ref
        [InlineData("GET", "Products(10)/RoutingCustomers(20)/$ref", "Product.ReadByKey", "GetProductCustomerRef(10, 20)")]
        [InlineData("POST", "MyProduct/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/RoutingCustomers/$ref", "MyProduct.Update", "CreateMyProductCustomerRef")]
        [InlineData("DELETE", "Products(10)/Microsoft.AspNet.OData.Authorization.Tests.Models.SpecialProduct/RoutingCustomers(20)/$ref", "Product.Update", "DeleteProductCustomerRef(10, 20)")]
